...
const Footer = () => {
  ...
  return (
    <footer className="bg-apartment-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="text-xl font-bold mb-4">ApartmentFinder</h3>
            <p className="text-gray-300">
              Finding your dream apartment made simple. Let us do the work so you can focus on making your new place a home.
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400">© {currentYear} ApartmentFinder. All rights reserved.</p>
